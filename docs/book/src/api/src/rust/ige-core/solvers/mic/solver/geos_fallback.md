# ige-core::solvers::mic::solver::geos_fallback <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>


## Functions

### `ige-core::solvers::mic::solver::geos_fallback::solve_with_geos`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn solve_with_geos (host : & HostPolygon , opts : & MicOptions , existing_seg_index : Option < & SegmentIndex > ,) -> std :: result :: Result < MicResult , MicError >
```
...
### `ige-core::solvers::mic::solver::geos_fallback::geos_tolerance`
...
### `ige-core::solvers::mic::solver::geos_fallback::host_polygon_to_wkt`
...
### `ige-core::solvers::mic::solver::geos_fallback::parse_geos_output`
...
### `ige-core::solvers::mic::solver::geos_fallback::parse_wkt_coord_list`
