# ige-core::solvers::lir::oriented::parallel <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `ige-core::solvers::lir::oriented::parallel::Candidate`
...
### `ige-core::solvers::lir::oriented::parallel::TinyRng`
...
##### `new` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>
...
##### `next_u64` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>
...
##### `uniform` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>
...
##### `normal` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>
...
### `ige-core::solvers::lir::oriented::parallel::RotatedCoords`
...
### `ige-core::solvers::lir::oriented::parallel::rotate_coords_only`
...
Rotate a polygon's coordinates around its centroid without allocating a `Polygon<f64>`.  The bounding-box falls out of the single coord pass.
...
### `ige-core::solvers::lir::oriented::parallel::build_mask_parallel`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn build_mask_parallel (exterior : & [Coord < f64 >] , interiors : & [Vec < Coord < f64 > >] , xs : & [f64] , ys : & [f64] ,) -> Vec < bool >
```
...
### `ige-core::solvers::lir::oriented::parallel::generate_angles`
...
### `ige-core::solvers::lir::oriented::parallel::wrap_angle_90`
...
### `ige-core::solvers::lir::oriented::parallel::cross2`
...
### `ige-core::solvers::lir::oriented::parallel::point_in_rotated_polygon`
...
### `ige-core::solvers::lir::oriented::parallel::ray_distance_to_boundary`
...
### `ige-core::solvers::lir::oriented::parallel::clamp_ratio_about_center`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn clamp_ratio_about_center (x0 : f64 , y0 : f64 , x1 : f64 , y1 : f64 , max_ratio : f64 , min_ratio : f64 ,) -> (f64 , f64 , f64 , f64)
```
...
### `ige-core::solvers::lir::oriented::parallel::cross_ray_clearances`
...
### `ige-core::solvers::lir::oriented::parallel::candidate_from_clearances`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn candidate_from_clearances (angle_deg : f64 , cx : f64 , cy : f64 , (dpx , dnx , dpy , dny) : (f64 , f64 , f64 , f64) , max_ratio : f64 , min_ratio : f64 ,) -> Option < (Candidate , f64) >
```
...
### `ige-core::solvers::lir::oriented::parallel::candidate_from_cross_rays_rotated`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn candidate_from_cross_rays_rotated (rc : & RotatedCoords , cx : f64 , cy : f64 , angle_deg : f64 , max_ratio : f64 , min_ratio : f64 ,) -> Option < (Candidate , f64) >
```
...
### `ige-core::solvers::lir::oriented::parallel::vertex_snapped_valid_candidate`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn vertex_snapped_valid_candidate (rc : & RotatedCoords , angle : f64 , max_ratio : f64 , min_ratio : f64 , field_max_coords : usize ,) -> Option < Candidate >
```
...
### `ige-core::solvers::lir::oriented::parallel::center_seed_from_unconstrained_rect`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn center_seed_from_unconstrained_rect (rc : & RotatedCoords , angle : f64 , max_ratio : f64 , min_ratio : f64 , current_best_area : f64 ,) -> Option < Candidate >
```
...
### `ige-core::solvers::lir::oriented::parallel::try_fast_path_rectangle`
...
Fast-path detector for near-rectangular shapes. DISABLED: Area calculation was incorrect, causing false triggers on non-rectangular polygons (33-41% fill ratio shapes attempting 45° rotations). To re-enable, need accurate signed area computation and higher threshold (>0.90).
...
### `ige-core::solvers::lir::oriented::parallel::run_simulated_annealing_candidates`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn run_simulated_annealing_candidates (poly : & Polygon < f64 > , seeds : & [Candidate] , max_ratio : f64 , min_ratio : f64 , coarse_steps : usize ,) -> Vec < Candidate >
```
...
### `ige-core::solvers::lir::oriented::parallel::coarse_evaluate_angles`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn coarse_evaluate_angles (poly : & Polygon < f64 > , angles : & [f64] , coarse_steps : usize , max_ratio : f64 , min_ratio : f64 ,) -> Vec < Candidate >
```
...
### `ige-core::solvers::lir::oriented::parallel::coarse_evaluate_angle`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn coarse_evaluate_angle (poly : & Polygon < f64 > , angle : f64 , coarse_steps : usize , max_ratio : f64 , min_ratio : f64 ,) -> Option < Candidate >
```
...
### `ige-core::solvers::lir::oriented::parallel::fine_solve_candidate`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn fine_solve_candidate (poly : & Polygon < f64 > , candidate : & Candidate , max_ratio : f64 , min_ratio : f64 , always_return : bool , field_max_coords : usize , cert_eps : f64 , cert_max_shrink : f64 ,) -> Option < LirOrientedResult >
```
...
### `ige-core::solvers::lir::oriented::parallel::build_result`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn build_result (poly : & Polygon < f64 > , angle : f64 , (x0 , y0 , x1 , y1) : (f64 , f64 , f64 , f64) , max_ratio : f64 , always_return : bool , centroid : & Point < f64 > , cert_eps : f64 , cert_max_shrink : f64 ,) -> Option < LirOrientedResult >
```
...
### `ige-core::solvers::lir::oriented::parallel::rotate_point`
...
### `ige-core::solvers::lir::oriented::parallel::solve_lir_oriented_parallel`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn solve_lir_oriented_parallel (poly : & Polygon < f64 > , options : & LirOrientedOptions) -> Result < LirOrientedResult >
```
