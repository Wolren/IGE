# ige-core::solvers::lir::axis_aligned::vertex_grid <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::AxisAlignedOptions`
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::largest_rect_in_histogram`
...
```rust
fn largest_rect_in_histogram (heights : & [usize] , xs : & [f64] , ys : & [f64] , row_idx : usize ,) -> (f64 , f64 , f64 , f64 , f64)
```
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::subdivide_coords`
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::compute_row_intervals`
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::clamp_aspect_ratio`
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::solve_vertex_grid`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn solve_vertex_grid (poly : & Polygon < f64 > , options : & AxisAlignedOptions) -> Option < Rectangle >
```
...
### `ige-core::solvers::lir::axis_aligned::vertex_grid::detect_polygon_type`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn detect_polygon_type (poly : & Polygon < f64 >) -> PolygonType
```
