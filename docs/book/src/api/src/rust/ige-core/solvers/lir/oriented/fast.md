# ige-core::solvers::lir::oriented::fast <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `ige-core::solvers::lir::oriented::fast::maybe_fast_path`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn maybe_fast_path (poly : & Polygon < f64 > , max_ratio : f64 , min_ratio : f64) -> Option < (Polygon < f64 > , f64 , f64 , f64) >
```
...
### `ige-core::solvers::lir::oriented::fast::rotate_point`
