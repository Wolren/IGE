# ige-core::solvers::lir::axis_aligned::exact <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `ige-core::solvers::lir::axis_aligned::exact::capped_coords`
...
### `ige-core::solvers::lir::axis_aligned::exact::collect_unique_coords`
...
### `ige-core::solvers::lir::axis_aligned::exact::aspect_ok`
...
### `ige-core::solvers::lir::axis_aligned::exact::refine_side_min_x`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn refine_side_min_x (poly : & Polygon < f64 > , x0 : f64 , y0 : f64 , x1 : f64 , y1 : f64 , x_min_bound : f64 , max_ratio : f64 ,) -> f64
```
...
### `ige-core::solvers::lir::axis_aligned::exact::refine_side_max_x`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn refine_side_max_x (poly : & Polygon < f64 > , x0 : f64 , y0 : f64 , x1 : f64 , y1 : f64 , x_max_bound : f64 , max_ratio : f64 ,) -> f64
```
...
### `ige-core::solvers::lir::axis_aligned::exact::refine_side_min_y`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn refine_side_min_y (poly : & Polygon < f64 > , x0 : f64 , y0 : f64 , x1 : f64 , y1 : f64 , y_min_bound : f64 , max_ratio : f64 ,) -> f64
```
...
### `ige-core::solvers::lir::axis_aligned::exact::refine_side_max_y`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--fg); color: white;">private</span>


```rust
fn refine_side_max_y (poly : & Polygon < f64 > , x0 : f64 , y0 : f64 , x1 : f64 , y1 : f64 , y_max_bound : f64 , max_ratio : f64 ,) -> f64
```
...
### `ige-core::solvers::lir::axis_aligned::exact::refine_continuous`
...
### `ige-core::solvers::lir::axis_aligned::exact::push_top_seed`
...
### `ige-core::solvers::lir::axis_aligned::exact::best_discrete_support_rect`
...
### `ige-core::solvers::lir::axis_aligned::exact::solve_axis_exact`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn solve_axis_exact (poly : & Polygon < f64 > , options : & AxisAlignedOptions) -> Option < Rectangle >
```
