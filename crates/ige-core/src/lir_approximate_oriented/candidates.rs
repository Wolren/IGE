...
use crate::lir_axis_aligned::sdf::polygon_sdf;
use crate::lir_axis_aligned::solve_axis_rect_grid;
use crate::lir_approximate_oriented::AngleCandidate;
use crate::lir_approximate_oriented::prepare::simplify_for_solve;
